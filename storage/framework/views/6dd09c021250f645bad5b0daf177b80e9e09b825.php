...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        Les autorisations :
        <small>vous pouvez cherchez des autorisations</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        <?php endif; ?>
            ...
            <div class="">
                ...
                <form class="navbar-form" role="search" method="GET" action="<?php echo e(url("/searchautorisation")); ?>">
        <div class="input-group">
        ...
        <tr>
                ...
                <?php if($autorisation->situation==1): ?>
                <tr>
                    <td> <?php echo e($autorisation->badgenumber); ?> </td>
                    ...
                    <?php echo e(link_to_route('autorisation.edit','Modifier',[$autorisation->id],['class' =>'btn btn-primary'])); ?>
