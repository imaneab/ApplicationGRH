...
<div class="container">
    <div class="row">
        ...
        <?php endif; ?>
                ...
                <tr>
                    <td> <?php echo e($utilisateur->badgenumber); ?> </td>
                    <td><?php echo e($utilisateur->email); ?></td>
                    <td>
                    <?php echo Form::open(array('route'=>['utilisateur.destroy',$utilisateur->id],'method'=>'DELETE')); ?> 
                    <?php echo e(link_to_route('utilisateur.edit','Modifier',[$utilisateur->id],['class' =>'btn btn-primary'])); ?>
