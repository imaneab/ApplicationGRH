    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
               ...
               <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/help')); ?>">
                        <?php echo e(csrf_field()); ?>

                       
                        <div class="form-group<?php echo e($errors->has('badgenumber') ? ' has-error' : ''); ?>">
                            <label for="badgenumber" class="col-md-4 control-label">Numero de badge</label>

                            <div class="col-md-6">
                                <input id="badgenumber" type="text" class="form-control" name="badgenumber" value="<?php echo e(old('badgenumber')); ?>">

                                <?php if($errors->has('badgenumber')): ?>
                                    <span class="help-block">
                                        <strong><?php echo e($errors->first('badgenumber')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                            <br><br>
                        ...
                        <div class="form-group<?php echo e($errors->has('confirm_password') ? ' has-error' : ''); ?>">
                            <label for="confirm_password" class="col-md-4 control-label">Confirmer le mot de passe</label>
