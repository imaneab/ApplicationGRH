...
<div class="container">
    <div class="row">
        ...
        <?php endif; ?>
            ...
            <div class="">
                ...
                <form class="navbar-form" role="search" method="GET" action="<?php echo e(url("/searchyesaut")); ?>">
        <div class="input-group">
        ...
        <table class="table">
                ...
                <th>Endroit de mission</th>
                
                </tr>

                <?php foreach($autorisations as $autorisation): ?>
                <?php if($autorisation->situation==0): ?>
                <tr>
                    
                    
                    <td><?php echo e($autorisation->nombre_jours); ?></td>
                    <td><?php echo e($autorisation->date_debut); ?></td>
                    <td><?php echo e($autorisation->date_retour); ?></td>
                    <td><?php echo e($autorisation->moyen_transport); ?></td>
                    <td><?php echo e($autorisation->endroit_mission); ?></td>
                   
                    
                    <td>
                    <form action="<?php echo e(url('valider_autorisation')); ?>" method="post">
                      <input type="submit" value="valider" class="btn btn-success" onClick="ConfirmMessage()">
                      <input type="hidden" value="<?php echo e($autorisation->id); ?>" name="id">
                   ...
                   <?php echo Form::open(array('route'=>['autorisation.destroy',$autorisation->id],'method'=>'DELETE')); ?>

                     <?php echo Form::button('Annuler',['class'=>'btn btn-danger','type'=>'submit']); ?>
 ...
 <script type="text/javascript">
        function ConfirmMessage(){
          if(confirm("Voulez-vous valider l autorisation ?"))
          {  
            return true;
          }
          else
