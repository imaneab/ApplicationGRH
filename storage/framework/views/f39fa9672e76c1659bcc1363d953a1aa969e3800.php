    ...
    <div class="row">
        ...
        <?php endif; ?>
            ...
            <div class="">
                ...
                <form class="navbar-form" role="search" method="GET" action="<?php echo e(url("/searchcon")); ?>">
        <div class="input-group">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <th>Fonction de conjoint</th> : <td><b><?php echo e($fonctionnaire->fonction_conjoint); ?></b></td>
       ...
       <?php echo Form::open(array('route'=>'autorisation.store')); ?>
       ...
       <input type="text" name="moyen_transport">
       <br><br>
       <b>Endroit de mission :</b>
       &nbsp;
       <input type="text" name="endroit_mission">
       ...
       <div class="form-group">
              <?php echo Form::button('Créer',['type'=>'submit','class'=>'btn btn-primary']); ?>
