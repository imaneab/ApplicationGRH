...
<div class="container">
    <div class="row">
        ...
        <?php endif; ?>
            ...
            <div class="">
                ...
                <form class="navbar-form" role="search" method="GET" action="<?php echo e(url("/searchyes")); ?>">
        <div class="input-group">
        ...
        <table class="table">
                ...
                <tr>
                    ...
                    <td>
                    <form action="<?php echo e(url('valider_conge')); ?>" method="post">
                      <input type="submit" value="valider" class="btn btn-success" onClick="ConfirmMessage()">
                      <input type="hidden" value="<?php echo e($conge->id); ?>" name="id">
 ...
 <script type="text/javascript">
        function ConfirmMessage(){
          if(confirm("Voulez-vous valider le congé ?"))
          {  
            return true;
          }
          else
