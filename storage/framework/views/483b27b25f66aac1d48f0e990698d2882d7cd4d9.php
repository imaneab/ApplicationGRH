    ...
    <div class="row">
        ...
        <?php endif; ?>
            ...
            <div class="">
                ...
                <form class="navbar-form" role="search" method="GET" action="<?php echo e(url("/searchatt")); ?>">
        <div class="input-group">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <th>Fonction de conjoint</th> : <td><b><?php echo e($fonctionnaire->fonction_conjoint); ?></b></td>
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Remarque</th> : <td><b><?php echo e($fonctionnaire->remarque); ?></b></td><br><br>
           ...
           <a href="download/<?php echo e($fonctionnaire->file_name); ?>" download="<?php echo e($fonctionnaire->file_name); ?>">
<button type="button" class="btn btn-primary"><i class="glyphicon glyphicon-download"> Demander l'attestation de travail</i></button>
</a>
