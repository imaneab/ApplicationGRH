        ...
        <div class="input-group">
            ...
            <div class="input-group-btn">
              ...
              <!--  <th>Action</th> -->
                ...
                <tr>
                    <td> {{ $fonctionnaire->badgenumber }} </td>
                    <td>{{ $fonctionnaire->nom }}</td>
                    <td>{{ $fonctionnaire->prenom }}</td>
                    <td>{{ $fonctionnaire->fonction }}</td>
                    <td>{{ $fonctionnaire->division }}</td>
                    <td>{{ $fonctionnaire->genre }}</td>
                    <td>{{ $fonctionnaire->CIN }}</td>
                    <td>{{ $fonctionnaire->service }}</td>
                  <!--   <td>{{ $fonctionnaire->date_affectation }}</td>
                    <td>{{ $fonctionnaire->date_entree_administration }}</td>
                    <td>{{ $fonctionnaire->grade }}</td>
                    <td>{{ $fonctionnaire->date_grade }}</td>
                    <td>{{ $fonctionnaire->echelle }}</td>
                    <td>{{ $fonctionnaire->echelon }}</td>
                    <td>{{ $fonctionnaire->date_echelon }}</td>
                    <td>{{ $fonctionnaire->situation_familiale }}</td>
                    <td>{{ $fonctionnaire->budget }}</td>
                    <td>{{ $fonctionnaire->niveau_scolaire }}</td>
                    <td>{{ $fonctionnaire->nombre_enfants }}</td>
                    <td>{{ $fonctionnaire->nom_complet_conjoint }}</td>
                    <td>{{ $fonctionnaire->fonction_conjoint }}</td>
                    <td>{{ $fonctionnaire->diplome }}</td>
                    <td>{{ $fonctionnaire->nom_pere }}</td>
                    <td>{{ $fonctionnaire->nom_mere }}</td>
                    <td>{{ $fonctionnaire->remarque }}</td>-->
               <!--     <td>
