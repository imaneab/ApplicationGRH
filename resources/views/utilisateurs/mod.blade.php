...
<div class="container">
    <div class="row">
        ...
        @endif
                ...
                <tr>
                    <td> {{ $utilisateur->badgenumber }} </td>
                    <td>{{ $utilisateur->email }}</td>
                    <td>
                    {!! Form::open(array('route'=>['utilisateur.destroy',$utilisateur->id],'method'=>'DELETE')) !!} 
                    {{ link_to_route('utilisateur.edit','Modifier',[$utilisateur->id],['class' =>'btn btn-primary']) }}
