    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
               ...
               <form class="form-horizontal" role="form" method="POST" action="{{ url('/help') }}">
                        {{ csrf_field() }}
                       
                        <div class="form-group{{ $errors->has('badgenumber') ? ' has-error' : '' }}">
                            <label for="badgenumber" class="col-md-4 control-label">Numero de badge</label>

                            <div class="col-md-6">
                                <input id="badgenumber" type="text" class="form-control" name="badgenumber" value="{{ old('badgenumber') }}">

                                @if ($errors->has('badgenumber'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('badgenumber') }}</strong>
                                    </span>
                                @endif
                            </div>
                            <br><br>
