    ...
    <div class="row">
        ...
        @endif
            ...
            <div class="">
                ...
                <form class="navbar-form" role="search" method="GET" action="{{url("/searchconge")}}">
        <div class="input-group">
        ...
        <table class="table">
                ...
                @if($conge->situation==1)
                <tr>
                    <td> {{ $conge->badgenumber }} </td>
                    <td>{{ $conge->type_conge }}</td>
                    <td>{{ $conge->nombre_jours }}</td>
                    <td>{{ $conge->nombre_jours_consomes }}</td>
                    <td>{{ $conge->nombre_jours_restants }}</td>
                    ...
                    {{ link_to_route('conge.edit','Modifier',[$conge->id],['class' =>'btn btn-primary']) }}
