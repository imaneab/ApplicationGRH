    ...
    <div class="row">
        ...
        @endif
            ...
            <div class="">
                ...
                <form class="navbar-form" role="search" method="GET" action="{{url("/searchyes")}}">
        <div class="input-group">
        ...
        <table class="table">
                ...
                <tr>
                    ...
                    <td>
                    <form action="{{url('valider_conge')}}" method="post">
                   ...
                   {!! Form::open(array('route'=>['conge.destroy',$conge->id],'method'=>'DELETE')) !!}
