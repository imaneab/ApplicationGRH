    ...
    <div class="row">
        ...
        @endif
            ...
            <div class="">
                ...
                <form class="navbar-form" role="search" method="GET" action="{{url("/searchautorisation")}}">
        <div class="input-group">
        ...
        <tr>
                ...
                @if($autorisation->situation==1)
                <tr>
                    <td> {{ $autorisation->badgenumber }} </td>
                    <td>{{ $autorisation->nombre_jours }}</td>
                    <td>{{ $autorisation->date_debut }}</td>
                    <td>{{ $autorisation->date_retour }}</td>
                    <td>{{ $autorisation->moyen_transport }}</td>
                    <td>{{ $autorisation->endroit_mission }}</td>
                    <td>
                    {!! Form::open(array('route'=>['autorisation.destroy',$autorisation->id],'method'=>'DELETE')) !!} 
                    {{ link_to_route('autorisation.edit','Modifier',[$autorisation->id],['class' =>'btn btn-primary']) }}
